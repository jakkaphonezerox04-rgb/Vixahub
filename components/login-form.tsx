...
export default function LoginForm() {
  ...
  const handleSocialLogin = (provider: string) => {
    if (provider === "google") {
      ...
      setError("การเข้าสู่ระบบผ่าน Social Media ยังไม่พร้อมใช้งาน")
    }
  }
      ...
      <div className="space-y-3 mb-6">
        ...
        <div className="flex gap-3">
          <button
            ...
            className="flex-1 flex items-center justify-center gap-2 px-4 py-3 bg-gray-800/50 border border-gray-600/50 rounded-xl text-white hover:bg-gray-700/50 transition-all duration-300 hover:scale-105"
          >
